...
Public Class ImageHelp
    'Private Shared CollPF As PrivateFontCollection
    ...
    Private Shared ReadOnly FontFilesExist As Boolean = File.Exists(Folder.Apps + "\Fonts\FontAwesome.ttf") AndAlso File.Exists(Folder.Apps + "\Fonts\Segoe-MDL2-Assets.ttf")
    Private Shared ReadOnly FFamilySegoe As New FontFamily("Segoe MDL2 Assets")
    Private Shared ReadOnly FontSagoe As New Font(FFamilySegoe, 12)
    ...
    Shared Function GetSymbolImage(symbol As Symbol) As Image
        ...
        'If CollPF Is Nothing Then
        '    CollPF = New PrivateFontCollection
        '    CollPF.AddFontFile(AwesomePath)
        'End If
        If FontAwesome Is Nothing AndAlso symbol > 61400 Then
            Dim coll = New PrivateFontCollection
            coll.AddFontFile(Folder.Apps + "\Fonts\FontAwesome.ttf")
            FontAwesome = New Font(coll.Families(0), 12)
        End If

        'Dim family As FontFamily

        'If symbol > 61400 Then
        '    'If CollPF.Families.Length > 0 Then
        '    family = CollPF.Families(0)
        'Else
        ...
        Dim font = If(symbol > 61400, FontAwesome, FontSagoe)
