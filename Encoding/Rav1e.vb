...
Public Class Rav1eParams
    ...
    Overloads Function GetArgs(pass As Integer,
        ...
        If includePaths AndAlso includeExecutable Then
            sb.Append(Package.ffmpeg.Path.Escape + " -loglevel " & s.FfmpegLogLevel & $" -hide_banner{If(script.Path.Ext = "vpy", " -f vapoursynth", "")} -i " + script.Path.Escape + " -f yuv4mpegpipe -strict -1 - | " + Package.Rav1e.Path.Escape)
        End If
